...
export const ModelSelector: React.FC<ModelSelectorProps> = ({
  ...
  if (!currentModel || !selectedProviderModel) {
    return (
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        aria-label={`Current model: ${currentModel.name} from ${Object.values(groupedModels).flat().find(o => o.model.name === currentModel.name)?.providerName || ''}. Click to change model.`}
      >
